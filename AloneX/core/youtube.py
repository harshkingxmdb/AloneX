import os import random import asyncio import yt_dlp from pathlib import Path

from py_yt import VideosSearch

from AloneX import config, logger from AloneX.helpers import Track, utils

Safe import

try: from AloneX.helpers.NexGenApi import NexGenApi except ImportError: NexGenApi = None

class YouTube: def init(self): self.api = None self.base = "https://www.youtube.com/watch?v=" self.cookies = [] self.checked = False self.cookie_dir = "AloneX/cookies" self.warned = False
