...
class Thumbnail:
    ...
    async def generate(self, song: Track, size=(1280, 720)) -> str:
        try:
            ...
            rect = ImageOps.fit(thumb, self.rect, method=Image.Resampling.LANCZOS, centering=(0.5, 0.5))
            ...
            draw.text((1185, 650), str(song.duration), font=self.font1, fill=self.fill)
